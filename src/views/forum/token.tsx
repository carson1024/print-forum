...
const TokenDetail = () => {
  ...
  return (
    <ForumLayout>
      <div
        className={`border-r border-gray-800 overflow-hidden ${isTopLoading || isLoading ? "loading" : ""}`}
      >
        <div className="grid grid-rows-[90px_76px_1fr] flex-col h-screen border-gray-800">
          <div className="flex border-b border-gray-800 flex items-center ">
            <button onClick={() => navigate(-1)}>
              <img
                src={Prev}
                className="w-[24px] h-[24px] mr-[12px] ml-[12px]"
              />
            </button>
            {isLoading ? (
              <div className="w-8 h-8 sm:w-[52px] sm:h-[52px] circle skeleton mr-[12px]" />
            ) : (
              <img
                src={callReport?.info.imageUrl}
                className="w-8 h-8 sm:w-[52px] sm:h-[52px] circle mr-[12px]"
              />
            )}
            <div className="space-y-[5px]">
              {isLoading ? (
                <div className="skeleton w-24 h-4 sm:w-[300px] sm:h-[20px] rounded"></div>
              ) : (
                <div className="flex space-x-[12px] items-center">
                  <span className="text-sm text-[14px] font-semibold items-center text-white">
                    ${callReport?.baseToken.symbol}
                  </span>
                  ...
                  {sitem?.is_featured ? (
                    <div>
                      <span
                        className={`badge-multiplier-${sitem?.featured}X w-[35px] h-[21px]  text-[#59FFCB] text-[12px] font-semibold items-center flex`}
                      ></span>
                    </div>
                  ) : (
                    <></>
              ...
              {isTopLoading ? (
                <div className="skeleton w-24 h-4 sm:w-[600px] sm:h-[20px] rounded"></div>
              ) : (
                <div className="flex space-x-[6px] items-center">
                  <span className="token_info text-gray-600 text-[12px] font-Medium space-x-[5px]">
                    Callers
                    <span className="token_border text-white">
                      {callersCount}
                    </span>
                  </span>
                  <span className="token_info text-gray-600 text-[12px] font-Medium space-x-[5px]">
            ...
            <div className="border-r border-gray-800 flex flex-col h-screen">
              <div className="grid grid-rows-[50px_1fr] border-gray-800 ">
                <div className="border-b items-center flex">
                  <div className="m-[18px] text-[14px] font-semibold text-white items-center flex">
                    Top Callers
                  </div>
                </div>
                    ...
                    >
                      {isLoading || !topCallers.length ? (
                        ...
                        topCallers.map((caller, index) => (
                          <Link
                            to={`/profile?id=${caller.users.id}&tag=1`}
                            key={index}
                          >
                            <div className="mb-[18px]">
                              <div className="topcaller_border items-center flex flex-1 grid flex-col">
                                <div className="number_border text-[12px] font-Medium text-white">
                                  #{index + 1}
                                </div>
                                  ...
                                  <div className="flex items-center space-x-[6px]">
                                    <div className="flex space-x-[12px] items-center">
                                      <div className="text-[#76767E] text-[12px] font-Medium flex">
                                        MCAP&nbsp;
                                        {formatNumber(caller.init_market_cap)}
                                        <span className="text-sm items-center flex">
                                          <AiFillCaretRight />
                                        </span>
                                      ...
                                      {caller.users?.is_featured ? (
                                        <div>
                                          <span
                                            className={`badge-multiplier-${caller.users?.featured}X w-[35px] h-[21px]  text-[#59FFCB] text-[12px] font-semibold items-center flex`}
                                          ></span>
                                        </div>
                                      ) : (
                                        <></>
                      ...
                      <>
                        <div className="">
                          <div className="flex items-center mb-[2px]">
                            ...
                            <span className="text-[12px] font-Medium text-[#76767E] ml-auto">
                              {formatTimestamp(me[0].created_at)} ago
                            </span>
                          </div>
                          <div className="items-center">
                        ...
                        <>
                          <div className="">
                            <div className="flex items-center mb-[2px]">
                              ...
                              <span className="text-[12px] font-Medium text-[#76767E] ml-auto">
                                {formatTimestamp(discussion.created_at)} ago
                              </span>
                            </div>
                            <div className="items-center">
                              <span className="text-[12px] font-Medium text-gray-600">
                      ...
                      admindiscussions?.map((admindiscussion) => (
                        <>
                          <div className="">
                            <div className="flex items-center mb-[2px]">
                              <span
                                className={`badge-rank-10 w-[20px] h-[20px] mr-[6px]`}
                              ></span>
                              <span className="text-[14px] font-Medium text-white mr-[6px]">
                                Administrator
                              </span>
                              <span className="text-[12px] font-Medium text-[#76767E] ml-auto">
                                {formatTimestamp(admindiscussion.created_at)}{" "}
                                ago
                              </span>
                            </div>
                            <div className="items-center">
                              <span className="text-[12px] font-Medium text-gray-600">
                                {admindiscussion.comment}
                              </span>
                            </div>
                            <div className="border-b border-gray-800 mt-[18px] mb-[18px]"></div>
                          </div>
