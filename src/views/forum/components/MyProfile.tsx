    ...
    <>
      <div className="h-screen bg-black text-white ">
        <div className="grid grid-rows-[100px_170px_98px_197px_270px_1fr_50px] h-screen border-gray-800">
          <div className=" border-b border-gray-800 items-center justify-center">
            <div className="m-[18px]">
              <div className="flex items-center">
                ...
                <button onClick={() => setIsRingModalOpen(true)}>
                  <img
                    src={Ring}
                    className="w-[24px] h-[24px] mr-[8px] ml-auto"
                  />
                </button>
                <button>
              ...
              <div className="flex items-center mt-[20px]">
                <div className="text-gray-400 text-[12px] font-Medium">
                  Win rate {user?.winrate}% | Total calls {user?.callcount} |
                  Account age {formatTimestamp(user?.created_at)}{" "}
                </div>
              </div>
            </div>
          </div>
            ...
            {!user ? (
              <div className="m-[18px]">
                <div className="flex items-center profileXP mb-[20px]">
                  <span
                    className={`badge-rank-1 w-[36px] h-[36px] mr-[6px]`}
                  ></span>
                  <span className="text-[14px] font-semibold text-white flex items-center justify-center">
                    Rank 1
                  </span>
                  <span className="text-[12px] font-Medium text-gray-600 flex items-center ml-auto">
                    Since Apr 29, 2025
                  </span>
                </div>
                <div className="XP space-y-[8px]">
                  <div className="flex">
                    <span className="text-[12px] font-Medium text-gray-600 flex items-center">
                      Rank progression
                    </span>
                    <span className="text-[14px] font-semibold text-white flex items-center ml-auto">
                      Rank 3
                    </span>
                  </div>
                  <div
                  ...
                  >
                    <div
                      className="flex bg-primary h-2 rounded-full"
                      style={{ width: "16.5%", height: "12px" }}
                    ></div>
                  </div>
                  <div className="flex">
              ...
              <div className="m-[18px]">
                <div className="flex items-center profileXP mb-[20px]">
                  <span
                    className={`badge-rank-${user?.rank} w-[36px] h-[36px] mr-[6px]`}
                  ></span>
                  <span className="text-[14px] font-semibold text-white flex items-center justify-center">
                    Rank {user?.rank}
                  </span>
          ...
          <div className=" border-b border-gray-800 items-center justify-center">
            <div className="m-[18px]">
              <span className="text-[14px] font-semibold text-white flex items-center mb-[16px]">
                Achievements
              </span>
              <div className="flex space-x-[6px]">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You reached rank 1"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("1x") ? (
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You reached rank 2"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("2x") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You reached rank 3"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("3x") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You reached rank 4"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("4x") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You reached rank 5"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("5x") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You reached rank 6"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("6x") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You reached rank 7"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("7x") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You reached rank 8"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("8x") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You reached rank 9"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("9x") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You reached rank 10"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("10x") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You set your Telegram address"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("t") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You set your Twitter address"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("x") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You set your Solana address"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("s") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You get 5X marketCap"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("c5x") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You get 10X marketCap"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("c10x") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You get 50X marketCap"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("c50x") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You get 100X marketCap"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("c100x") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="10 people copytrade you"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("u10") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="50 people copytrade you"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("u50") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="100 people copytrade you"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("u100") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You earn 50K-money"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("m50k") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You earn 100K-money"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("m100k") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You earn 500K-money"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("m500k") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You earn 1m-money"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("m1m") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="Your account has 1 month history"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("reg1m") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="Your account has 3 months history"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("reg3m") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="Your account has 1 year history"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("reg1y") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You are a influencer"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("influ") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  ...
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("alpha") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You have a best partner"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("partner") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You never did skip"
                  delay={[0, 0]}
                >
                  {user?.achievements.includes("never") ? (
                    <button className="text-yellow-400">
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You found some bugs of this site"
                  delay={[0, 0]}
                >
                ...
                <Tippy
                  theme="yellowTooltip"
                  content="You registered on this site"
                  delay={[0, 0]}
                >
            ...
            <div className="m-[18px]">
              <div className=" items-center wallet h-full grid-rows-[66px_1fr]">
                ...
                <div className="items-center flex justify-between mt-[4px]">
                  <button
                    className="btn_deposite mr-[8px] text-[12px] font-semibold text-[#59FFCB] items-center justify-center flex mainhover"
                  ...
                  <button
                    className="btn_withdraw text-[12px] font-semibold text-[#FF4949] items-center justify-center flex mainhover"
                    onClick={() => setIsWithdrawModalOpen(true)}
                  >
                    <img src={DownWithdraw} />
                    Withdraw
                  </button>
                </div>
              </div>
          ...
          <div className=" border-b border-gray-800 items-center justify-center">
            <div className="m-[18px] h-full">
              <div className="flex mb-[20px]">
                <button
                  className={`btn_profile text-[12px] font-semibold ${activeTag == "mtrade" ? "text-primary " : "text-[#76767E]"}  items-center justify-center flex mr-[8px] mainhover`}
                  onClick={() => {
                    setActiveTag("mtrade");
                ...
                <button
                  className={`btn_profile text-[12px] font-semibold ${activeTag == "mcall" ? "text-primary " : "text-[#76767E]"} items-center justify-center flex mainhover`}
                  onClick={() => setActiveTag("mcall")}
                >
                  My Calls
                </button>
                <button
                  className={`btn_outline text-[11px] font-semibold ${activeTag == "alltrade" ? "text-primary " : "text-[#76767E]"} items-center justify-center flex ml-auto mainhover`}
                  onClick={() => setActiveTag("alltrade")}
                >
                  All Trades
                </button>
              </div>
                        ...
                        <div key={index} className="border-b-[1px] border-black/10 space-y-[8px] justify-evenly h-full mb-[8px]">
                          <div className="flex items-center">
                            <div className="gray space-x-[4px] text-[12px]">
                              ...
                              <button className="rounded-full bg-black/10 text-white/60 text-xs">
                                UsernameLong
                              </button>
                            </div>
                          ...
                          <div className="border-b-[1px] flex text-[12px] font-Medium justify-between">
                            <div className="">
                              <p className="text-xs text-white/60 mb-[4px]">
                                Pair
                              </p>
                              <p className="text-xs text-white mb-[4px]">
                                UNIUSDT
                              </p>
                            </div>
                            <div className="">
                      ...
                      <div className="space-y-2 ">
                        {isLoading || !callList.length ? (
                          ...
                          callList.map((call, index) => (
                            <div className="rounded-full border border-gray/15 flex justify-between items-center p-1 pr-3">
                              <div className="flex gap-1 items-center">
                                <img
                                  src={call.image}
                                  className="w-8 h-8 sm:w-[40px] sm:h-[40px] recircle"
                                />
                                <span className="font-bold text-sm sm:text-base">
                                  ${call.symbol}
                                </span>
                                {call.is_featured ? (
                                  <span className="rounded-full bg-green-600 px-2 py-1.5 text-xs text-black font-semibold">
                                    {call.featured}X
                                  </span>
                                ) : (
                                  <></>
          ...
          <div className=" flex items-center border-gray-800 bg-black">
            <div className="m-[18px]">
              <button
                className="text-[14px] font-semibold text-[#76767E] p-1 "
                onClick={logout}
              >
                Log out
              </button>
