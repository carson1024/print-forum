    ...
    const scan = async () => {
      ...
      if (data) {
        const active = data.filter(
          (call) =>
            new Date(call.created_at).getTime() + 86400000 - Date.now() > 0
        );
        setPrevcall(active);
          ...
          <div className="grid grid-rows-[50px_1fr] border-gray-800 ">
            ...
            <div className="flex-1 overflow-y-auto h-[calc(100vh-202px)]">
              <div className="m-[18px]">
                <div className="text-[14px] font-Medium text-white items-center mb-[8px]">
                  Bio
                </div>
                <div className="text-[12px] font-Medium text-gray-600 items-center mb-[12px]">
                  {myprofile.bio}
                </div>
                <div className="flex mt-[16px] mb-[16px] ">
                  <span className="token_info text-gray-600 text-[12px] font-Medium mr-[8px] space-x-[5px]">
                    Followers
                    <span className="token_border text-primary">12</span>
                  </span>
                  <span className="token_info text-gray-600 text-[12px] font-Medium mr-[8px] space-x-[5px]">
                    Win&nbsp;Rate
                    <span className="token_border text-gray-600">
                      {myprofile.winrate}%
                    </span>
                  </span>
                  <span className="token_info text-gray-600 text-[12px] font-Medium mr-[8px] space-x-[5px]">
                  ...
                  <span className="token_info text-gray-600 text-[12px] font-Medium mr-[8px] space-x-[5px]">
                    Account&nbsp;Age
                    <span className="token_border text-white">
                      {formatTimestamp(myprofile.created_at)}
                    </span>
                  </span>
                </div>
                ...
                <div className="flex items-center profileXP mb-[16px]">
                  ...
                  <span className="text-[12px] font-Medium text-gray-600 flex items-center ml-auto">
                    {formatSinceDate(myprofile?.created_at)}
                  </span>
                </div>
                <div className="border-b border-gray-800 mb-[16px]"></div>
                <div className="text-[14px] font-Medium text-white items-center mb-[8px]">
                ...
                <div className=" space-x-[6px] mb-[16px]">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("1x") ? (
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("2x") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("3x") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("4x") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("5x") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("6x") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("7x") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("8x") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("9x") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("10x") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("t") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("x") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("s") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("c5x") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("c10x") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("c50x") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("c100x") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("u10") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("u50") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("u100") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("m50k") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("m100k") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("m500k") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("m1m") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("reg1m") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("reg3m") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("reg1y") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("influ") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("alpha") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("partner") ? (
                      <button className="text-yellow-400">
                  ...
                  <Tippy
                    ...
                    delay={[0, 0]}
                  >
                    {myprofile?.achievements.includes("never") ? (
                      <button className="text-yellow-400">
