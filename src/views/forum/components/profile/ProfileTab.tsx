  ...
  return (<>
    <div className="flex lg:hidden py-[10px] border-b border-gray-800 flex items-center justify-between px-[16px]">
      <div className="flex gap-2">
        <button
          className={`px-3 py-2 rounded-[6px] text-[10px] font-semibold ${activeTab2 === 'about'
    ...
    <div className="lg:hidden px-[16px] py-[12px]">
      {activeTab2 === 'about' && (
        <div className="lg:flex-1 overflow-y-auto h-[calc(100vh-202px)]">
          <div className=''>
            <div className="flex flex-col gap-2.5">

              <div className='text-[12px] lg:text-[14px] font-Medium text-white items-center lg:mb-[8px]'>Bio</div>
              <div className='text-[10px] lg:text-[12px] font-Medium text-gray-600 items-center lg:mb-[12px]'>{myprofile.bio}</div>
            </div>
            <div className='flex py-4 gap-2 '>
              <span className="token_info text-gray-600 text-[10px] lg:text-[12px] font-Medium lg:mr-[8px] space-x-[5px]">Followers<span className="token_border text-primary">12</span></span>
              <span className="token_info text-gray-600 text-[10px] lg:text-[12px] font-Medium lg:mr-[8px] space-x-[5px]">Win&nbsp;Rate<span className="token_border text-gray-600">{myprofile.winrate}%</span></span>
              <span className="token_info text-gray-600 text-[10px] lg:text-[12px] font-Medium lg:mr-[8px] space-x-[5px]">Calls<span className="token_border text-white">{myprofile.callcount}</span></span>
              <span className="token_info text-gray-600 text-[10px] lg:text-[12px] font-Medium lg:mr-[8px] space-x-[5px]">
                Account&nbsp;Age
                <span className="token_border text-white">
                  {/* Mobile: show only the first part | LG and up: show full */}
                  <span className="block lg:hidden">
                    {formatTimestamp(myprofile.created_at).split(' ')[0]}
                  </span>
            ...
            <div className="flex items-center profileXP mb-[16px]">
              ...
              <span className="text-[14px] font-semibold text-[#84E4FF] flex items-center justify-center">Rank {myprofile.rank}</span>
              <span className="text-[10px] lg:text-[12px] font-Medium text-[#84E4FF66] flex items-center ml-auto">{formatSinceDate(myprofile?.created_at)}</span>
            </div>
            <div className="border-b border-gray-800 mb-[16px]"></div>
            ...
            <div className="border-b lg:block hidden border-gray-800 mb-[16px]"></div>
            <div className="flex gap-3 flex-col">

            <a className='flex' href={`https://explorer.solana.com/address/${myprofile.saddress}`} target="_blank" rel="noopener noreferrer" ><button className='btn_link mainhover text-[14px] font-semibold text-[#FFFFFF]  '><img className='mr-[8px]' src={Solana} />Follow&nbsp;on&nbsp;Solana</button></a>
            <a className='flex' href={`https://x.com/${myprofile.xaddress}`} target="_blank" rel="noopener noreferrer" ><button className='btn_link mainhover text-[14px] font-semibold text-[#FFFFFF]  '><img className='mr-[8px]' src={Twitter} />Follow&nbsp;on&nbsp;X</button></a>
      ...
      {activeTab2 === 'latest' && (
        <div>
          <div className="lg:flex-1 overflow-y-auto h-[calc(100vh-202px)]">
            <div
              className={`flex-1 overflow-auto flex flex-col gap-2 ${isLoading ? "overflow-hidden loading" : "overflow-auto"}`}>
          ...
          <div className="flex-1 overflow-y-auto h-[calc(100vh-202px)]">
            <div className='m-[18px]'>
              ...
              <div className='flex mt-[16px] mb-[16px] '>
                <span className="token_info text-gray-600 text-[10px] lg:text-[12px] font-Medium mr-[8px] space-x-[5px]">Followers<span className="token_border text-primary">12</span></span>
                <span className="token_info text-gray-600 text-[10px] lg:text-[12px] font-Medium mr-[8px] space-x-[5px]">Win&nbsp;Rate<span className="token_border text-gray-600">{myprofile.winrate}%</span></span>
                <span className="token_info text-gray-600 text-[10px] lg:text-[12px] font-Medium mr-[8px] space-x-[5px]">Calls<span className="token_border text-white">{myprofile.callcount}</span></span>
                <span className="token_info text-gray-600 text-[10px] lg:text-[12px] font-Medium mr-[8px] space-x-[5px]">Account&nbsp;Age<span className="token_border text-white">{formatTimestamp(myprofile.created_at)}</span></span>
              </div>
              <div className="border-b border-gray-800 mb-[16px]"></div>
              <div className="flex items-center profileXP mb-[16px]">
                <span className={`badge-rank-1 w-[36px] h-[36px] mr-[6px]`}></span>
