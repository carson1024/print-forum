    ...
    <div className="border-r border-gray-800 overflow-auto">
      <div className="grid grid-rows-[76px_1fr] flex-col h-screen border-gray-800">
        ...
        <div className="flex border-b border-gray-800 flex justify-between p-[18px]">
          <div className=" flex flex-col gap-2.5 lg:gap-5  flex-grow loading">
        { 
          ...
          <div className="lg:bg-gray-50 bg-transparent border border-[#FFFFFF1A] lg:border-none p-2.5 lg:p-1.5 circle flex items-center justify-between">
            <div className="lg:flex flex-wrap items-center gap-3">
              ...
              <div className="lg:p-2.5 lg::p-3 lg:circle lg:border lg:border-gray-150 flex items-center gap-2.5">
                ...
                <div className="space-y-0.5 flex lg:block items-center gap-1">
                  <div className=" text-[10px] md:text-xs text-gray-600">Rank { item.rank}</div>
              ...
              <div className="lg:px-3 lg:sm:px-[18px] pt-2 lg:py-3 circle overflow-auto lg:border border-gray-150 flex-col lg:flex-row flex lg:items-center gap-2 lg:flex-wrap">
                ...
                <div className="flex items-center gap-2 sm:gap-2">
                  <div className=" text-[10px] md:text-xs lg:bg-gray-100 px-1 py-1 sm:px-2 sm:py-1.5 flex items-center gap-1 circle">
                ...
                <div className=" text-[10px] md:text-xs bg-primary/20 px-1 py-1 sm:px-2 sm:py-1.5 hidden lg::flex items-center gap-1 circle">
                  <span className="text-primary">Calls</span>
                  <span className="text-[#59FFCB] text-[10px] lg:text-sm lg:text-primary font-bold">{item.callcount?item.callcount : 0}</span>
                </div>
              </div>
