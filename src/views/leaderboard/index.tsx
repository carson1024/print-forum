  ...
  return (<LeaderboardLayout>
    <div className="border-r border-gray-800 overflow-auto">
      <div className="grid grid-rows-[76px_1fr] flex-col h-screen border-gray-800">
        ...
        <div className="hidden  border-b border-gray-800 flex items-center px-[18px]">
          ...
          <span className="text-[18px] font-semibold text-[#76767E]">Ranking</span>
        </div>
          ...
          <div className="lg:bg-gray-50 bg-transparent border border-[#FFFFFF1A] lg:border-none p-2.5 lg:p-1.5 circle flex items-center justify-between">
            <div className="lg:flex flex-wrap items-center gap-3">
              ...
              <div className=" flex items-center gap-2.5">
                <div className={`circle-item lg:w-[20px] lg:h-[20px] w-[18px] h-[18px] bg-red-300 text-black text-[9px] lg text-[10px]:md:text-sm font-bold badge-rank-${item.rank}`}></div>
              ...
              <div className=" max-[500px]:pt-3   overflow-auto  flex-col lg:flex-row flex lg:items-center gap-1 lg:gap-2 lg:flex-wrap">
                <div className="flex items-center gap-2">
                  <span className=" text-[10px] md:text-xs text-gray-600">Win ratio :</span>
                  <div className=" text-[10px] md:text-xs bg-primary/20 px-2 py-1.5  hidden  items-center gap-1 rounded-full">
                    <span className="text-primary">Calls</span>
                    <span className="text-primary font-bold">{item.callcount}</span>
                  </div>
                </div>
                <div className="flex items-center gap-2 sm:gap-2">
                  <div className=" text-[10px] md:text-xs lg:px-1 lg:py-1 sm:px-2 sm:py-1.5 flex items-center gap-1 circle">
                    <span className="text-[#76767E]">Week</span>
                    <div className="px-[3px] rounded-[3px] h-[16px] bg-[#59FFCB33] flex items-center">

                    <span className="text-[#59FFCB] text-[10px] lg:text-xs  font-bold">{item.weekrate?item.weekrate : 0}%</span>
                    </div>
                  </div>
                  <div className=" text-[10px] md:text-xs lg:px-1 lg:py-1 sm:px-2 sm:py-1.5 flex items-center gap-1 circle">
                    <span className="text-[#76767E]">Month</span>
                    <div className="px-[3px] rounded-[3px] h-[16px] bg-[#59FFCB33] flex items-center">

                    <span className="text-[#59FFCB] text-[10px] lg:text-xs font-bold">{item.monthrate?item.monthrate : 0}%</span>
                    </div>
                  </div>
                  <div className=" text-[10px] md:text-xs lg:px-1 lg:py-1 sm:px-2 sm:py-1.5 flex items-center gap-1 circle">
                    <span className="text-[#76767E]">All time</span>
                    <div className="px-[3px] rounded-[3px] h-[16px] bg-[#59FFCB33] flex items-center">

                    <span className="text-[#59FFCB] text-[10px] lg:text-xs font-bold">{item.winrate?item.winrate : 0 }%</span>
                    </div>
                  </div>
                  <div className=" text-[10px] md:text-xs lg:px-1 lg:py-1 sm:px-2 sm:py-1.5 flex items-center gap-1 circle">
                    <span className="text-[#76767E]">Calls</span>
                    <div className="px-[3px] rounded-[3px] h-[16px] bg-[#1C1B1F] flex items-center">

                    <span className="text-[#FFFFFF] text-[10px] lg:text-xs font-bold">{item.callcount?item.callcount : 0 }%</span>
                    </div>
                  </div>
                </div>
                <div className=" text-[10px] md:text-xs bg-primary/20 lg:px-1 lg:py-1 sm:px-2 sm:py-1.5 hidden lg::flex items-center gap-1 circle">
                  <span className="text-primary">Calls</span>
                  <span className="text-[#59FFCB] text-[10px] lg:text-xs font-bold">{item.callcount?item.callcount : 0}</span>
                </div>
              </div>
            </div>
