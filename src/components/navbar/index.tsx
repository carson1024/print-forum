        ...
        <div className="text-gray-400 m-[20px]">
          ...
          }
          {
            activeTab == 'copy' ?
              ...
              <Link to="/copytrading"><button className="flex whitespace-nowrap items-center w-full px-[9px] py-[6px] text-[13px] font-semibold mainhover mb-[12px]" onClick={() => setActiveTab('copy')}>
