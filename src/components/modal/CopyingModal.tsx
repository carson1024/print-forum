  ...
  return (
    <Modal isOpen={isOpen} onClose={onCancel}>
      <div className="w-[470px]">
        <div className="flex">
          <img src={User_modal} />
          <span className="ml-[12px] text-[18px] font-semibold text-white">
            {" "}
            Start Copying
          </span>
        </div>
        ...
        <div className="space-y-[16px] mt-[16px]">
          ...
          <div className="flex items-center gap-3">
            <div>
              <span className="text-[14px] font-semibold text-white mr-[4px]">
                UsernameLong
              </span>
          ...
          <div className="flex items-center justify-between flex-wrap gap-2">
            <div className="flex items-center gap-2">
              <span className="token_info text-gray-600 text-[12px] font-Medium space-x-[5px]">
                Followers
                <span className="small_border circle text-primary space-x-[5px]">
                  12
                </span>
              </span>
              <span className="token_info text-gray-600 text-[12px] font-Medium space-x-[5px]">
                Win rate
                <span className="gray_border text-white space-x-[5px]">
                  56%
                </span>
              </span>
              <span className="token_info text-gray-600 text-[12px] font-Medium space-x-[5px]">
                Calls<span className=" text-white space-x-[5px]">125</span>
              </span>
              <span className="token_info text-gray-600 text-[12px] font-Medium space-x-[5px]">
                Account age
                <span className=" text-white space-x-[5px]">2 years</span>
              </span>
            </div>
          </div>
        </div>
        ...
        {/* Divider */}
        <div className=" mt-[16px] mb-[16px] text-[12px] font-Medium text-gray-600">
        ...
        <button
          className="w-full bg-primary text-black text-[14px] font-semibold circle py-3"
          onClick={onOk}
        >
          Start Copying
        </button>
