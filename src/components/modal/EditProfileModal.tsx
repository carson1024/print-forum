...
const EditProfileModal = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onCancel} extraClass="w-[620px]">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-3">
            {isLoading ? (
              <img
                src={IconUser}
                className="w-[12px] h-[12px] sm:w-[82px] sm:h-[82px] circle"
              />
            ) : (
              <>
                {preview ? (
            ...
            <div className="space-y-2">
              ...
              {isLoading ? (
                ...
                <button
                  className=" sm:flex items-center gap-2 text-sm bg-gray-50 px-3 py-2 rounded-full"
                  onClick={handleButtonClick}
                >
                  <img src={IconUpload} className="w-5 h-5" /> Upload new
                  picture
                </button>
              )}
