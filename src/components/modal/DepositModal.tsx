  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="space-y-6 w-[470px]">
        <div className="flex">
          <div
            className=" flex items-center gap-1 text-[14px] font-semibold text-[#59FFCB]"
            onClick={openWallet}
          >
            <ImArrowUp size={12} />
        ...
        {/* Address Input */}
        <div
          className="bg-gray-50 sm:px-6 py-3 circle text-white flex items-center gap-2"
          onClick={handleCopy}
        >
          ...
          <button className="text-gray-400">
            {!isCopied ? (
              <img
                src={IconCopy}
                className="w-4 h-4 sm:w-6 sm:h-6 opacity-40"
              />
            ) : (
