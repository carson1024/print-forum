...
const LoginModal = ({
  ...
  return <Modal isOpen={isOpen} onClose={onClose} extraClass="w-[92%] sm:w-auto">
    ...
    <div className="w-[405px]  mt-[16px] space-y-[16px]">
      <span className="text-[16px] text-white font-semibold]">Log in to your account in order to <br /> participate in the vote</span>
      <p className="font-Medium text-[12px] text-gray-600 mb-4">Need help with your account? <span className="text-primary cursor-pointer">Get Support</span></p>
      ...
      <div className="flex items-center gap-4 w-full">
        <div className="relative flex items-center input-field !px-2 sm:!px-4 circle grow">
          ...
          <button className="btn_logincard text-[10px] font-semibold text-black text-[12px] !hidden sm:!flex !py-3" onClick={() => handleLogin('email', email)} disabled={isSending}>Send code</button>
        </div>
